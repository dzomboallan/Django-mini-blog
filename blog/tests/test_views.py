...
class BlogListView(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for blog_num in range(number_of_blogs):
            BlogPost.objects.create(name='Test Blog %s' % blog_num,author=blog_author,description='Test Blog %s Description' % blog_num)
    ...
    def test_pagination_is_five(self):
        ...
        self.assertEqual( len(resp.context['blogpost_list']), 5)